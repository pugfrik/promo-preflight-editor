...
An editor for restaurant promos — it reviews your drafted promotion
...
money, staff hours, or reputation on a promotion.

## How to use it

1. Add every file in this folder to a Claude project's knowledge (no
   special order needed — Claude reads them all). If you're pasting into
   a plain conversation instead, paste in this order: `identity.md`,
...
that flag risks for your lawyer — it never gives legal advice.
